...
CCeasaHelperApp::CCeasaHelperApp() noexcept {
	// TODO: replace application ID string below with unique ID string; recommended
	// format for string is CompanyName.ProductName.SubProduct.VersionInformation
	SetAppID(_T("CeasaHelper.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CCeasaHelperApp object

CCeasaHelperApp theApp;

// CCeasaHelperApp initialization

BOOL CCeasaHelperApp::InitInstance() {
...
int CCeasaHelperApp::ExitInstance() {
